...
type MenuItemViewErrorProps = {
  error: Error & { digest?: string };
  reset: () => void;
};

function MenuItemViewError({ error, reset }: MenuItemViewErrorProps) {
  return (
      ...
      <div className='w-full max-w-sm'>
        <Card>
          <CardHeader className='text-center'>
            ...
            <CardDescription>
              We encountered an error while loading the menu item details.
...
export default MenuItemViewError;
